<?php
/**
 * @package link-changer-htaccess
 * @version 1.1
 */
/*
Plugin Name: link-changer-htaccess
Text Domain: link-changer-htaccess
Plugin URI: https://wordpress.org/plugins/link-changer-htaccess/
Description: Helps to create redirection rules before URL changing. Useful for creating/changing human-readable URLs and make redirection with .htaccess to prevent brocken URL. Can be use before changing url with cyr2lat or ukr2lat Wordpress plugins.
...
function my_plugin_create_db() {
	...
	$table_name = $wpdb->prefix . 'old_linky';
            ...
            dbDelta( $sql );
            add_option( 'link-changer-htaccess_db_version', $my_products_db_version );
